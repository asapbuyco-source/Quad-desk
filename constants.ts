...
// --- Dark Pool / Institutional Signal Thresholds ---
// The "Signal vs Noise" filter described in the engineering spec.
export const DARK_POOL_THRESHOLDS = {
    /** Minimum BTC size to appear in the Whale Feed (≈ $10M at $20k/BTC) */
    WHALE_MIN_BTC: 500,
    /** Max price-impact % to classify a trade as a "Cross / OTC" block trade */
    BLOCK_TRADE_PRICE_IMPACT_MAX: 0.01,
    /**
     * SIGNIFICANCE THRESHOLD (Anti-Alert-Fatigue gate)
     * Only trigger a "Sentiment Shift" if cumulative Dark Pool volume in the
     * last hour exceeds 0.5% of the 24h average daily volume.
     * Below this, events are tracked but do NOT influence the Sentinel gate.
     */
    SIGNIFICANCE_THRESHOLD_PCT: 0.005,
    /** Rolling window (hours) for the Aggregated Bias Gauge */
    BIAS_WINDOW_HOURS: 4,
    /** How often (ms) to refresh dark pool data and update global darkPoolBias */
