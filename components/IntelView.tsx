                            ...
                            >
                                <div className="md:col-span-8 p-6 rounded-2xl bg-gradient-to-br from-zinc-900 to-black border border-white/10 relative overflow-hidden group">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <h2 className="text-xl md:text-2xl font-medium text-white leading-relaxed font-light italic">
                                ...
                                <div className="md:col-span-4 flex flex-col gap-4">
                                    <div className="flex-1 p-5 rounded-2xl bg-zinc-900/50 border border-white/5 flex items-center justify-between relative overflow-hidden">
                                        ...
                                        <div>
                                            ...
                                            <span className={`text-2xl font-black ${data.intelligence.whale_impact === 'High' ? 'text-amber-400' : 'text-white'
                                                }`}>
                                                {data.intelligence.whale_impact}
                                            </span>
                                        </div>
                                        <div className="h-full flex items-center">
                                            <div className={`w-2 h-12 rounded-full ${data.intelligence.whale_impact === 'High' ? 'bg-amber-500 shadow-[0_0_15px_rgba(245,158,11,0.5)]' :
