    ...
    while True:
        try:
            ...
            payload = {
                ...
                "lastAnalysis":    stats.get("last_analysis", ""),
                "currentZScore":   stats.get("current_zscore", 0.0),
                "currentRegime":   stats.get("current_regime", "UNKNOWN"),
                "currentBayes":    stats.get("current_bayes", 0.5),
                "currentRSI":      stats.get("current_rsi", 50.0),
                "currentOFI":      stats.get("current_ofi", 0.0),
                "currentATR":      stats.get("current_atr_pct", 0.0),
                # P17: Open Interest analytics surfaced from oi_analytics_engine
                "oiZScore":        stats.get("oi_zscore", 0.0),
                "oiDelta1mPct":    stats.get("oi_delta_1m_pct", 0.0),
                "oiDelta5mPct":    stats.get("oi_delta_5m_pct", 0.0),
                "oiVelocityPct":   stats.get("oi_velocity_pct", 0.0),
                "priceOIRegime":   stats.get("price_oi_regime", "INDETERMINATE"),
                "oiRiskLabel":     stats.get("oi_risk_label", "UNKNOWN"),
                "fundingOISignal": stats.get("funding_oi_signal", "NEUTRAL"),
                "oiUsdM":          stats.get("oi_usd_M", 0.0),
